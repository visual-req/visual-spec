...
- 内嵌领域/行业补充标准（如存在；作为领域补充标准参与合并）：
  - `prompts/vspec_qc/banking_quality_cases.md`
  - `prompts/vspec_qc/logistics_quality_standard.md`
  - `prompts/vspec_qc/pharmaceutical_quality_standard.md`
  - `prompts/vspec_qc/healthcare_quality_standard.md`
  - `prompts/vspec_qc/manufacture_quality_standard.md`
  - `prompts/vspec_qc/govermental_quality_standard.md`
  - `prompts/vspec_qc/public_service_quality_standard.md`
  - `prompts/vspec_qc/retail_quality_standard.md`
...
1. 合并质量标准：
   - 以“内嵌质量标准”为默认基线
   - 若存在任一“内嵌领域/行业补充标准”文件：将其作为内嵌的领域补充标准（优先级高于内嵌基线，但低于项目级覆盖）
